        ...
        <MDBCard alignment='center'>
            ...
            <MDBCardBody>
                <MDBValidation onSubmit={handleSubmit} noValidate className='row g-3'>
                    ...
                    <div className='col-md-12'>
                        <MDBInput label="Şifre" type="password" value={password} name="password" onChange={onInputChange} required invalid validation="Please provide your password" />
                    </div>
            ...
            <MDBCardFooter>
                <Link to="/register">
                    <p style={{margin:"0px"}}>Hesabın yok mu? Kayıt ol</p>
                </Link>
                <hr style={{margin:"8px",color:"blue"}}/>
                <Link to="/forgotPassword">
                    <p style={{margin:"0px"}}>Şifreni mi unuttun?</p>
                </Link>
            </MDBCardFooter>
        </MDBCard>
    </div>
